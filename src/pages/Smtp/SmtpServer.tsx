...
import { getSmtpServersApi, deleteSmtpServerApi, type SmtpServerData } from "../../api/smtpApi/smtpApi";
...
const SmtpServer: React.FC = () => {
  ...
  const headers = ["Name (From Email)", "SMTP Host", "SMTP Port", "SMTP User", "Security", "Actions"];
      ...
      <DataTable 
        ...
        renderRow={(server, index) => (
          <tr key={server.id || index} className="hover:bg-gray-50 dark:hover:bg-gray-700 border-b border-gray-200 dark:border-gray-700">
             ...
             <td className="px-4 py-4 whitespace-nowrap text-sm text-text-primary dark:text-white">{server.smtpHost}</td>
             <td className="px-4 py-4 whitespace-nowrap text-sm text-text-primary dark:text-white">{server.smtpPort}</td>
             <td className="px-4 py-4 whitespace-nowrap text-sm text-text-primary dark:text-white">{server.smtpUser}</td>
             <td className="px-4 py-4 whitespace-nowrap text-sm text-text-primary dark:text-white">{server.security}</td>
