...
import { Home, Plus, Edit, Trash, Eye, Layers } from "lucide-react";
...
const CustomerRate: React.FC = () => {
  ...
  return (
    <div className="container mx-auto" onClick={() => setContextMenuPos(null)}>
      ...
      <DeleteModal isOpen={!!deleteId} onClose={() => setDeleteId(null)} onConfirm={handleDelete} title="Delete Customer Rate" message={deleteMessage} />
    </div>
  );
};
