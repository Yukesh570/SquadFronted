...
const VendorTransaction: React.FC = () => {
  ...
  return (
    <div className="container mx-auto" onClick={() => setContextMenuPos(null)}>
      ...
      <style>{`
        .vendor-transaction-table > div > div:first-child > div:first-child > div:first-child {
          display: none !important;
        }
        .vendor-transaction-table > div > div:first-child > div:first-child > div:last-child {
          display: none !important;
        }
        .vendor-transaction-table td {
          padding-top: 0.625rem !important;
          padding-bottom: 0.625rem !important;
        }
        .vendor-transaction-table th {
          padding-top: 0.5rem !important;
          padding-bottom: 0.5rem !important;
        }
        .vendor-transaction-table th:first-child,
        .vendor-transaction-table td:first-child {
          min-width: 56px !important;
          width: 56px !important;
        }
      `}</style>

      <div ref={tableWrapperRef} className="vendor-transaction-table">
        <DataTable
          serverSide={true}
          data={transactions}
